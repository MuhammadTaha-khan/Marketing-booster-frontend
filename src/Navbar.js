...
const NavbarComponent = ({loggedIn,logOut}) => {
  ...
  return (
    <Navbar expand="lg" className="navbar-expand-lg">
      <Container fluid>
        ...
        {/* <div className='mareting-logo' >
        <img src={marketing} alt="" style={{width:'100px', height:'100px'}}/>
        </div> */}
        ...
        {loggedIn ? ( 
          <button className="Nv-button" onClick={logOut}>Logout</button>

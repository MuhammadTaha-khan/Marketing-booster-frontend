...
// import ArrowForwardIosIcon from '@mui/icons-material/ArrowForwardIos';
// import ArrowBackIosIcon from '@mui/icons-material/ArrowBackIos';
import client01 from './images/client01.jpg';
import client02 from './images/client02.jpg';
import client03 from './images/client03.jpg';
import DragHandleIcon from '@mui/icons-material/DragHandle';
        ...
        <div className="responce-section">
            <Container>
                ...
                <Row className="justify-content-center mb-4">
                    <Col xs={10} md={4} lg={3} className=" testimonial-car">
                        <Col className='testimonial-card-head'>
                        <img src={client01} alt="Suncrop Group" className="testimonial-logo" />
                        <h5>Suncrop Group</h5>
                        </Col>
                    ...
                    <Col xs={10} md={4} lg={3} className=" testimonial-car">
                        <Col className='testimonial-card-head'>
                        <img src={client02} alt="Patron" className="testimonial-logo" />
                        <h5>Patron</h5>
                        </Col>
                        <p>Remarkable impact! Shahrukh transformed our digital presence at Patron. Their strategies were spot-on, driving notable growth. Highly recommended for exceptional digital marketing expertise.</p>
                        <div className="testimonial-rate">★★★★★</div>
                    ...
                    <Col xs={10} md={4} lg={3}  className=" testimonial-car">
                        <Col className='testimonial-card-head'>
                        <img src={client03} alt="Exin Group" className="testimonial-logo" />
                        <h5>Exin Group</h5>
                        </Col>
                        <p>Remarkable impact! Shahrukh transformed our digital presence at Patron. Their strategies were spot-on, driving notable growth. Highly recommended for exceptional digital marketing expertise.</p>
                        <div className="testimonial-rate">★★★★★</div>
